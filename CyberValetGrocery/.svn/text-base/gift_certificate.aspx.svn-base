<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="gift_certificate.aspx.cs" Inherits="CyberValetGrocery.gift_certificate" %>
    ...
    <table>
        ...
        <tr>
            <td class="formTextUSer">
               ...
               within one of the Zip Codes that we currently deliver to, then click here or 
        ...
        <tr>
            <td class="formTextUSer">
              To Purchase Online Gift Certificates 

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="updatePnl1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td align="center" bgcolor="#FFFFFF" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0" width="80%" style="padding-left: 10px;">
                            ...
                            <asp:Panel ID="pnlDelivery" runat="server">
                                ...
                                <tr>
                                    <td height="10px" align="left" style="padding-left: 200px">
                                        <asp:DropDownList ID="drpDelivery" runat="server" Width="150px" CssClass="DeliveryDropDown" OnSelectedIndexChanged="drpDelivery_SelectedIndexChanged"
                                            AutoPostBack="True">
                                        </asp:DropDownList>
                            ...
                            <asp:Panel runat="server" ID="pnlDeliveryType">
                                <tr>
                                    <td>
                                        <asp:Label Width="150px" ID="lblDeliveryType" Style="font-weight: bold;" Text="Pick your Delivery Type:"
                                            runat="server"> </asp:Label>
                                        <asp:DropDownList AutoPostBack="true" Width="150px" OnSelectedIndexChanged="ddlDeliveryType_SelectedIndexChanged" ID="ddlDeliveryType" runat="server" CssClass="DeliveryDropDown"
                                            Style="margin-top: 0px;" AppendDataBoundItems="true">
                                            <asp:ListItem Value="0">Select</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator InitialValue="0" ID="rfvDeliveryType" runat="server"
                                            ControlToValidate="ddlDeliveryType" ErrorMessage="Select Delivery Type">
                            ...
                            <asp:Panel ID="pnlStoreLocation" runat="server" Visible="false">
                                <tr>
                                    <td>
                                        <asp:Label Width="150px" ID="lblPickLocation" Style="font-weight: bold;" Text="Store Location:"
                                            runat="server"> </asp:Label>
                                        <asp:DropDownList ID="ddlstoreLocation" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStoreLocation_SelectedIndexChanged" CssClass="DeliveryDropDown"
                                            Style="margin-top: 0px;" AppendDataBoundItems="true">
                                            <asp:ListItem Value="0">Select</asp:ListItem>
                                        </asp:DropDownList>
         ...
         <strong style="padding-left:173px">  We enter the property as early as we can to stock your groceries before you arrive! <br />

 </strong> 
                                    <strong style="padding-left:173px">Select a general time slot reflecting your check-in time. </strong>
                                </td>
                            </tr>
                                            </table>
                                        </td>

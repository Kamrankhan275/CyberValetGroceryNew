<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="orderdetails.aspx.cs" Inherits="CyberValetGrocery.orderdetails" %>
...
></asp:ScriptManager>
    ...
    <ContentTemplate>
    <table cellpadding="0" cellspacing="0" border="0" width="580" style="padding-left: 10px;">
        <tr>
            <td height="20px">
            </td>
        </tr>
        ...
        <tr>
            <td style="padding-left:10px;">
                <table border="0" width="580" cellpadding="3" cellspacing="0" class="tableBorder">
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gridUserProductList" runat="server" AutoGenerateColumns="False"
                                PageSize="5" Width="580" CellPadding="0" CellSpacing="0"
                                GridLines="None">
                                <Columns>
                                <asp:TemplateField >
                                        <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/UserLoginMasterPage.Master" AutoEventWireup="true"
    CodeBehind="payment.aspx.cs" Inherits="CyberValetGrocery.payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Triggers> <asp:AsyncPostBackTrigger ControlID="btnPay" EventName="Click" /></Triggers>
        <ContentTemplate>
                ...
                <tr>
                    <td class="formTextUSer">
                        <table cellpadding="3" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td colspan="2" class="formTextUSer" align="left" style="padding-left: 80px;">
                                    <asp:Panel ID="pnlAutoCreditCard" runat="server" Visible="false">
                                        <table>
                                            ...
                                            <tr valign="top">
                                                <td align="right">
                                                    <span class="star1">*</span>Country:
                                                </td>
                                                <td>
                                                   <%--  <asp:TextBox ID="txtCountry" runat="server" CssClass="textbox1" MaxLength="2"></asp:TextBox>--%>
                                                  
                                              
                                            
                                                        <asp:DropDownList ID="drpCountry" runat="server" CssClass="DropDown" 
                                                ...
                                                <asp:ListItem Value="Select">Select</asp:ListItem>
                                                 ...
                                                 <asp:ListItem Value="US">United State</asp:ListItem>
                                                  <asp:ListItem Value="CA">Canada</asp:ListItem>
                                                       ...
                                                       <asp:RequiredFieldValidator ID="rfvCountry" runat="server" Text="*" ControlToValidate="drpCountry"
                                                        ErrorMessage="Country is reqiured" ForeColor="White" InitialValue="Select"></asp:RequiredFieldValidator> 
                                               <strong>US/CA</strong>
                                            </tr>
                                             <tr valign="top">
                                                <td align="right">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtZipCode" runat="server" CssClass="textbox1" MaxLength="10"></asp:TextBox>
                                            ...
                                            <tr valign="top">
                                                <td align="right">
                                                    <span class="star1">*</span>3 or 4 Digit Security Code:
                                                </td>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvCVV" runat="server" Text="*" ControlToValidate="txtPayCvv"
                                                        ErrorMessage="3 or 4-digit security code is required" ForeColor="White"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvFnm" runat="server" Text="*" ControlToValidate="txtFName"
                     ...
                     <tr valign="top">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Text="*" ControlToValidate="txtLName"
                    ...
                    <tr valign="top">
                        ...
                        <td>
                             <asp:TextBox ID="txtPayAddress1" runat="server" CssClass="textbox1"  MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="*" ControlToValidate="txtPayAddress1"
                                ErrorMessage="Billing address  is required" ForeColor="White"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     ...
                     <tr valign="top">
                        ...
                        <td>
                            <asp:TextBox ID="txtPayAddress2" runat="server" CssClass="textbox1" MaxLength="50"></asp:TextBox>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                             <asp:TextBox ID="txtPayCity" runat="server" CssClass="textbox1" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="*" ControlToValidate="txtPayCity"
                                ErrorMessage="City is required" ForeColor="White"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     ...
                     <tr valign="top">
                        ...
                        <td>
                            <asp:DropDownList ID="drpPayState" runat="server" CssClass="DropDown">
                           
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="*" ControlToValidate="drpPayState"
                                ErrorMessage="Select state" ForeColor="White" InitialValue="Select"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     ...
                     <tr valign="top">
                        ...
                        <td>
                            <asp:TextBox ID="txtPayZipCode" runat="server" CssClass="textbox1" MaxLength="5"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="*" ControlToValidate="txtPayZipCode"
                                ErrorMessage="Zip code is required" ForeColor="White"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtPayZipCode"
                     ...
                     <tr valign="top">
                        ...
                        <td>
                            <asp:TextBox ID="ttxPayCCNm" runat="server" CssClass="textbox1" MaxLength="16"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="*" ControlToValidate="ttxPayCCNm"
                                ErrorMessage="Credit card number is required" ForeColor="White"></asp:RequiredFieldValidator>
                    ...
                    <tr valign="top">
                              ...
                              <asp:ListItem Value="1">Visa</asp:ListItem>  
                                 <asp:ListItem Value="2">Credit Card</asp:ListItem>  
                                    <asp:ListItem Value="3">Master Card</asp:ListItem>  
                                     <asp:ListItem Value="4">Amex</asp:ListItem>                       
                           
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Text="*" ControlToValidate="drpPayCardType"
                                ErrorMessage="Select card type" ForeColor="White" InitialValue="Select"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     ...
                     <tr valign="top">
                        <td align="right">
                             <span class="star1">*</span>CVV: 
                        </td>
                        <td>
                            <asp:TextBox ID="txtPayCvv" runat="server" CssClass="textbox1" MaxLength="4"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" Text="*" ControlToValidate="txtPayCvv"
                                ErrorMessage="CVV is required" ForeColor="White"></asp:RequiredFieldValidator>
                    ...
                    <tr valign="top">
                        ...
                        <tr>
                        <td>
                        <asp:TextBox ID="txtPayExp" runat="server" MaxLength="6"></asp:TextBox>
                        </td>
                        <td style="padding-left:5px;">
                    ...
                    <tr valign="top">
                        <td align="left" colspan="2">
                        <asp:CheckBox ID="chkPay" runat="server" /> &nbsp; &nbsp;Check here if you would to save this information on file for future orders
                      </td>
                      </tr>
                            ...
                            <tr>
                           <td colspan="2" class="formTextUSer" align="left" style="padding-left: 80px;">
                            <asp:Panel ID="pnlUkPlus" runat="server" Visible="false">       
                                             <table>
                                             
                                               <tr valign="top">
                                                <td align="right">
                                                    <span class="star1">*</span>UK Plus Account Name:
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="TxtUkAcctName" runat="server" CssClass="textbox1" MaxLength="50"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvAcctname" runat="server" Text="*" ControlToValidate="TxtUkAcctName"
                                                        ErrorMessage="Account Name is required" ForeColor="White"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td align="right">
                                                    <span class="star1">*</span>UK Plus Account number 9 digits):
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="TxtUkAcctNo" runat="server" CssClass="textbox1" MaxLength="9"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvAccno" runat="server" Text="*" ControlToValidate="TxtUkAcctNo"
                                                        ErrorMessage="Account number is reqiured" ForeColor="White"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtUkAcctNo"
                                ErrorMessage="Invalid Account number 9 digits allowed" Text="*" ValidationExpression="\d{9}" ForeColor="White"></asp:RegularExpressionValidator>
                                                </td>
                                            </tr>
                                            </table>
                            </asp:Panel>

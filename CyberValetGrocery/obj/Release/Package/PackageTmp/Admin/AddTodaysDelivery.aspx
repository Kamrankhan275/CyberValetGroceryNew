<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="AddTodaysDelivery.aspx.cs" Inherits="CyberValetGrocery.Admin.AddTodaysDelivery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>
                <fieldset>
                    <legend>Add In about an hour service</legend>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="28%" height="40">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvSTime" runat="server" ControlToValidate="drpStartTime"
                                                ErrorMessage="Select start time" ForeColor="White" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="44%" align="right" class="formText">
                                        ...
                                        <td width="28%" height="40">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvTime" runat="server" ControlToValidate="drpEndTime"
                                                ErrorMessage="Select end time" ForeColor="White" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>

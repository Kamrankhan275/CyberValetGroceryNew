...
var overlapviewer = {
    ...
    endopacity: 1, //Opacity of element when mouse is over it (and showing enlarged image)
    ...
    dim_and_reveal: function(e, t, config) {
        ...
        $(t).fadeTo('normal', overlapviewer.endopacity, function() {
            ...
            config.$popupdiv.html('<img id="jkpopupimage" height="125" width="125" src="' + t.getAttribute('targetimage') + '" border="0" />')

...
{
    public partial class ViewClientActivityReport : System.Web.UI.Page
    {
        ...
        public void BindUSerGrid()
        {
            ...
            lblStDate.Text = strStartDate;
            lblEndDate.Text = strEndDate;
            lblZipNm.Text = strZipCode;
            dsUserList = dbListInfo.GetClientActivityInfo(strZipCode, strStartDate, strEndDate);
            ...
            if (dsUserList.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    strMsg = AppConstants.noClientActivityRec + " " + strStartDate + " and " + strEndDate + " " + AppConstants.noClientActivityRec1 + "(" + strZipCode + ")";
                    lblMsg.Text = strMsg;
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (dsUserList.Tables.Count > 0)
            {
                if (dsUserList != null && dsUserList.Tables.Count > 0 && dsUserList.Tables[0].Rows.Count > 0)
                {
                    ...
                    string strFileName = "ClientActivityForZip(" + strZipCode + ")Between_" + strStartDate + "and " + strEndDate + ".xls";

                    // string strFileName = "ClientActivityForZip.xls";
        ...
        protected void imgBack2_Click(object sender, ImageClickEventArgs e)
        {
            string strStateNm = string.Empty;
            string strZipCode = string.Empty;
            string strStartDate = string.Empty;
            ...
            strStartDate = Convert.ToString(Request.QueryString["sDate"]);
            strEndDate = Convert.ToString(Request.QueryString["eDate"]);
            Response.Redirect("ViewActivityDetails.aspx?chk=1&Zip=" + strZipCode + "&sDate=" + strStartDate + "&eDate=" + strEndDate, false);

<%@ Page Title="Add Delivery Date" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="AddDeliveryDate.aspx.cs" Inherits="CyberValetGrocery.Admin.AddDeliveryDate" %>
                                                                ...
                                                                <asp:DataList ID="dtlDelieveryTime" runat="server" GridLines="None" RepeatDirection="Vertical">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtTime" runat="server" CssClass="textBoxDateSmall" MaxLength="2" Text="30" ></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>

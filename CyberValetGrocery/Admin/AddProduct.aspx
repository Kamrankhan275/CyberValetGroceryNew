<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
   CodeBehind="AddProduct.aspx.cs" Inherits="CyberValetGrocery.Admin.AddProduct" ValidateRequest="false" %>
   ...
   <%-- <script  type="text/javascript">
        function EscapeField() {
            document.getElementById("txtTitle").value =
               escape(document.getElementById("txtTitle").value);
        }
</script>--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

   <%-- <script type language="JavaScript1.2">showHide("sitefunctions");</script>--%>
     <script type ="JavaScript1.2">showHide("sitefunctions");</script>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="56%" height="40">
                                            <asp:TextBox ID="txtTitle" runat="server" CssClass="textBox" MaxLength="50" ValidateRequestMode="Disabled"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td height="40" valign="top">
                                            <asp:DropDownList ID="drpType" runat="server" CssClass="DropDownBox">
                                                ...
                                                <asp:ListItem Value="0">Food Product</asp:ListItem>
                                                <asp:ListItem Value="1">Non Food Product</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td align="right" class="formText">
                                            <%-- <span class="star">*</span>--%>Pre-Sale Price($):
                                        </td>
                                        <td height="40">
                                    ...
                                    <%-- <tr>
                                        ...
                                        <td height="40" style="padding-left: 5px;">
                                            <asp:CheckBox ID="chkTaxItem" runat="server" />
                                        </td>
                                    </tr>--%>
                                    <tr>
                                        <td align="right" class="formText">
                                    ...
                                    <tr>
                                        ...
                                        <td height="40" style="padding-left: 5px;">
                                            <asp:FileUpload ID="uploadLargeImg" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" valign="top" class="formText">
                                    ...
                                    <tr>
                                        ...
                                        <td height="40">
                                            <%--  <asp:TextBox ID="txtDesc" runat="server" CssClass="multiLinetextbox" MaxLength="2000"
                                    ...
                                    <tr>
                                        ...
                                        <td height="40">
                                            <%--<asp:TextBox ID="txtComment" runat="server" CssClass="multiLinetextbox" MaxLength="2000"
                                                TextMode="MultiLine"></asp:TextBox>--%>

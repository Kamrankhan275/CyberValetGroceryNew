    ...
    public partial class EditProduct : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int intCheckImg = 0;
                intProduct = dbEditInfo.ProductNameUpdateAlreadyExist(Server.HtmlEncode(txtTitle.Text), txtSize.Text, productId);
               // intProduct = dbEditInfo.ProductNameUpdateAlreadyExist(txtTitle.Text, txtSize.Text, productId);
                if (intProduct == 0)
                {
                    ...
                    if (intCheckImg == 0)
                    {
                        ...
                        intUpdateProduct = dbEditInfo.UpdateProductInfo(Server.HtmlEncode(txtTitle.Text), FCKeditor1.Value, imgName, txtSize.Text, imgNameLarge, FCKeditor2.Value, txtStore.Text, productId);

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditStore.aspx.cs" Inherits="CyberValetGrocery.Admin.EditStore" %>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td width="56%" height="40">
                                                        <asp:TextBox ID="txtStoreName" runat="server" CssClass="textBox" MaxLength="50"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="rfvAisleName" runat="server" ControlToValidate="txtStoreName"
                                                            ErrorMessage="Store name is required" ForeColor="White" Text="*"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>

...
{
    public partial class admin_depositors : System.Web.UI.Page
    {
        ...
        protected void btnBegin_Click(object sender, EventArgs e)
        {
               ...
               // Response.Redirect("ViewAdminDepositors.aspx", false);
            ...
            try
            {
                ...
                if (Convert.ToInt32(drpSearchField.SelectedValue) == 0)
                {
                    intIn =0;
                }
                else
                ...
                Response.Redirect("ViewAdminDepositors.aspx?strKey=" + strKey + "&intIn=" + intIn +  "&locId=" + locId + "&perPage=" + perPage, false);
            }
            catch (Exception ex)
            {
                Response.Write(ex.Message);

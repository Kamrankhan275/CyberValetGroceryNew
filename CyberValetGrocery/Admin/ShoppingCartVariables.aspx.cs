            ...
            if (dsGetShoppingCartVariables.Tables.Count > 0)
            {
                if (dsGetShoppingCartVariables.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dtrow in dsGetShoppingCartVariables.Tables[0].Rows)
                    {
                        ...
                        //txtHourDeliveryFee.Text = Convert.ToDecimal(dtrow["OneHrDeliveryFee"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                        ...
                        txtPickUpDeliveryFee.Text = Convert.ToDecimal(dtrow["PickUpDeliveryFee"]).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture);
                    }
                }
            }
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    //intUpdateConstants = dbUpdateConstants.updateShoppingCartConstant(constantId, Convert.ToDouble(txtDeliveryFee.Text), Convert.ToDouble(txtTaxRate.Text), Convert.ToDouble(txtTaxRate1.Text), Convert.ToDouble(txtMinimumDeposit.Text), Convert.ToInt32(txtNoOfTimeSlot.Text), Convert.ToDouble(txtDeliveryFeeCutOff.Text), Convert.ToString(txtCustomerServiceemail.Text), Convert.ToString(txtContactEmail.Text), Convert.ToString(txtInfoEmail.Text), Convert.ToString(txtLocationName.Text), Convert.ToString(txtStateShortName.Text), Convert.ToString(txtStateLongName.Text), Convert.ToString(txtCompanyName.Text), Convert.ToString(txtCompanyLongName.Text), Convert.ToString(txtShortURL.Text), Convert.ToString(txtLongURL.Text), Convert.ToDouble(txtFirstOrderGift.Text), Convert.ToDouble(txtHourDeliveryFee.Text));
                    intUpdateConstants = dbUpdateConstants.updateShoppingCartConstant1(constantId, Convert.ToDouble(txtDeliveryFee.Text), Convert.ToDouble(txtTaxRate.Text), Convert.ToDouble(txtTaxRate1.Text), Convert.ToDouble(txtMinimumDeposit.Text), Convert.ToInt32(txtNoOfTimeSlot.Text), Convert.ToDouble(txtDeliveryFeeCutOff.Text), Convert.ToString(txtCustomerServiceemail.Text), Convert.ToString(txtContactEmail.Text), Convert.ToString(txtInfoEmail.Text), Convert.ToString(txtLocationName.Text), Convert.ToString(txtStateShortName.Text), Convert.ToString(txtStateLongName.Text), Convert.ToString(txtCompanyName.Text), Convert.ToString(txtCompanyLongName.Text), Convert.ToString(txtShortURL.Text), Convert.ToString(txtLongURL.Text), Convert.ToDouble(txtFirstOrderGift.Text), Convert.ToDouble(txtMemberDeliveryFee.Text), Convert.ToDouble(txtPickUpDeliveryFee.Text));

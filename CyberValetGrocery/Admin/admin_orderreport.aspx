<%@ Page Title="Order Report" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="admin_orderreport.aspx.cs" ValidateRequest="false" Inherits="CyberValetGrocery.Admin.admin_orderreport1" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <fieldset>
                            <legend>Order Report</legend>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="30" class="formText" nowrap="nowrap">
                                        Choose the dates below for which you would like to see all order details.
                                    </td>
                                </tr>

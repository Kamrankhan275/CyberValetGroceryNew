    ...
    public partial class UserForgotPasssword : System.Web.UI.Page
    {
        ...
        public int check()
        {
            ...
            try
            {
                ...
                //Create random password
                string CustomerServiceEmail = Convert.ToString(ViewState["CustomerServiceEmail"]); 
                strPwd = GetRandomPasswordUsingGUID(7);
                ViewState["Password"] = strPwd;
                strCompanyName = Convert.ToString(ViewState["CompanyShortName"]);
                ...
                request.AddParameter("to", "" + CustomerServiceEmail + ";" + txtEmail.Text + "");
                request.AddParameter("bcc", "" + CustomerServiceEmail + "");

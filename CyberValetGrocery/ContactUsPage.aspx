        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" border="0"  width="580px" style="padding-left: 10px;">
               ...
               <%-- <tr>
                ...
                <tr>
                    <td align="left">
                        <%-- <asp:Literal ID="litContactEmail1" runat="server"></asp:Literal>--%><a href="mailto:keri@lowcountrygroceryrunner.com" class="Userlink1">keri@lowcountrygroceryrunner.com</a>
                    </td>
                </tr>
                <tr>
                    <td height="10px">

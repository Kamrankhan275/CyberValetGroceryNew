...
Namespace CyberValetGrocery
    ...
    Public Class authorizenet
        ...
        Public arr_ccauthfields(18) As String
        ...
        Public Function GenPostdata(ByVal param1 As String)
            ...
            If mode = 0 Then
                ...
                arr_ccauthfields(1) = "&x_tran_key=" & strsendinfo(1)
            ...
            arr_ccauthfields(5) = "x_Card_Num"
            arr_ccauthfields(6) = "x_Exp_Date"
            arr_ccauthfields(7) = "x_Description"
            arr_ccauthfields(8) = "x_Amount"
            arr_ccauthfields(9) = "x_First_Name"
            arr_ccauthfields(10) = "x_Last_Name"
            arr_ccauthfields(11) = "x_company"
            arr_ccauthfields(12) = "x_Address"
            arr_ccauthfields(13) = "x_City"
            arr_ccauthfields(14) = "x_State"
            arr_ccauthfields(15) = "x_ZIP"
            arr_ccauthfields(16) = "x_Phone"
            arr_ccauthfields(17) = "x_Email"
            arr_ccauthfields(18) = "x_country"


            j = 3
            For i = 5 To UBound(arr_ccauthfields)
        ...
        Public Function transmit() As Boolean
            ...
            PostData = PostData '& "&x_Password=" & strsendinfo(1) 'test account password
            ...
            Dim myWebRequest As HttpWebRequest = WebRequest.Create(strsendinfo(2).ToString())
